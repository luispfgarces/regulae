namespace Regulae.Rql.Tests
{
    ...
    public class ReverseRqlBuilderTests
    {
        ...
        public void VisitInputConditionsSegment_GivenInputConditionsSegmentWithConditions_ReturnsRqlRepresentation()
        {
            ...
            // Assert
            actual.Should().Be("WHEN { @TestCondition1 is true, @TestCondition2 is 30 }");
        }
        ...
        public void VisitMatchExpression_GivenMatchExpressionWithConditions_ReturnsRqlRepresentation()
        {
            ...
            var matchExpression = MatchExpression.Create(matchKeyword, cardinalitySegment, rulesetExpression, matchDateExpression, inputConditionsSegment);
        ...
        public void VisitSearchExpression_GivenSearchExpressionWithInputConditions_ReturnsRqlRepresentation()
        {
            ...
            var searchExpression = new SearchExpression(searchKeyword, rulesKeyword, ruleset, datesInterval, inputConditions);
            ...
            // Assert
            actual.Should().Be("SEARCH RULES FOR \"test ruleset\" SINCE $2023-01-01$ UNTIL $2024-01-01$ WHEN { @TestCondition1 is \"abc\" }");
        }
