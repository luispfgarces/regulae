    ...
    public partial class InterpreterTests
    {
        ...
        public async Task InterpretAsync_GivenInvalidStatementThatIssuesAnError_ReturnsErrorStatementResult()
        {
            ...
            mockStatementToExecute
                .Setup(s => s.Accept(It.IsAny<IStatementVisitor<Task<Regulae.Rql.Pipeline.Interpret.IResult>>>()))
        ...
        public async Task InterpretAsync_GivenValidStatement_ExecutesAndReturnsResult()
        {
            ...
            mockStatementToExecute
                .Setup(s => s.Accept(It.IsAny<IStatementVisitor<Task<Regulae.Rql.Pipeline.Interpret.IResult>>>()))
                .Returns(Task.FromResult<Regulae.Rql.Pipeline.Interpret.IResult>(expected));
            var statements = new[] { mockStatementToExecute.Object };
        ...
        private static Statement CreateMockedStatement(Regulae.Rql.Pipeline.Interpret.IResult visitResult)
        {
            var mockStatement = new Mock<Statement>(RqlSourcePosition.Empty, RqlSourcePosition.Empty);
            mockStatement.Setup(s => s.Accept(It.IsAny<IStatementVisitor<Task<Regulae.Rql.Pipeline.Interpret.IResult>>>()))
                .Returns(Task.FromResult(visitResult));
        ...
        private static RqlDate NewRqlDate(DateTime value)
            => new RqlDate(value);
        ...
        private static RqlNothing NewRqlNothing()
            => new RqlNothing();
