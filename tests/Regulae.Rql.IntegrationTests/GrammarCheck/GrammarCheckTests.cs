namespace Regulae.Rql.IntegrationTests.GrammarCheck
{
    ...
    public class GrammarCheckTests
    {
        ...
        [
            "Regulae.Rql.IntegrationTests.GrammarCheck.CheckFiles.MatchExpressionChecks.yaml",
            "Regulae.Rql.IntegrationTests.GrammarCheck.CheckFiles.BasicLanguageChecks.yaml",
            "Regulae.Rql.IntegrationTests.GrammarCheck.CheckFiles.SearchExpressionChecks.yaml",
        ];
