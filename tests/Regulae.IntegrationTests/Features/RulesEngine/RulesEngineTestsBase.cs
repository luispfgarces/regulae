namespace Regulae.IntegrationTests.Features.RulesEngine
{
    using System;
    ...
    public abstract class RulesEngineTestsBase
    {
        ...
        protected RulesEngineTestsBase(RulesetNames testRuleset)
        {
            ...
            var compiledRulesEngine = RulesEngineBuilder
                ...
                .Configure(c => c.UseCompiledEvaluationStrategy()
                    .UseSmallestNumberPriorityCriteria())
                .Build();
            this.CompiledRulesEngine = compiledRulesEngine.MakeGeneric<RulesetNames, ConditionNames>(opt =>
            {
            ...
            var interpretedRulesEngine = RulesEngineBuilder
                ...
                .Build();
            this.InterpretedRulesEngine = interpretedRulesEngine.MakeGeneric<RulesetNames, ConditionNames>(opt =>
            {
                opt.AutoCreateConditions = true;
            });
        ...
        protected static DateTime UtcDate(string date)
