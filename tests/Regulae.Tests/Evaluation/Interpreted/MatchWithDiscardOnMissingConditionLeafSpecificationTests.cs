namespace Regulae.Tests.Evaluation.Interpreted
{
    ...
    public class MatchWithDiscardOnMissingConditionLeafSpecificationTests
    {
        ...
        public MatchWithDiscardOnMissingConditionLeafSpecificationTests()
        {
        ...
        [Fact]
        public void IsSatisfiedBy_GivenConditionsWithoutNeededInputCondition_ReturnsFalse()
        {
            // Arrange
            var expectedInput = new Dictionary<string, Operand>(StringComparer.Ordinal);
            Mock.Get(this.valueConditionNodeMock)
