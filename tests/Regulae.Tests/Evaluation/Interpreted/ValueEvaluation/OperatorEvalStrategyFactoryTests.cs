namespace Regulae.Tests.Evaluation.Interpreted.ValueEvaluation
{
    ...
    public class OperatorEvalStrategyFactoryTests
    {
        ...
        public void GetManyToManyOperatorEvalStrategy_GivenUnknownOperator_ThrowsNotSupportedException()
        {
            ...
            // Act
            var notSupportedException = Assert.Throws<NotSupportedException>(() => sut.GetManyToManyOperatorEvalStrategy(expectedOperator));
        ...
        public void GetManyToManyOperatorEvalStrategy_GivenUnsupportedOperator_ThrowsNotSupportedException(Operators @operator)
        {
            ...
            // Act
            var notSupportedException = Assert.Throws<NotSupportedException>(() => sut.GetManyToManyOperatorEvalStrategy(@operator));
        ...
        public void GetManyToOneOperatorEvalStrategy_GivenUnknownOperator_ThrowsNotSupportedException()
        {
            ...
            // Act
            var notSupportedException = Assert.Throws<NotSupportedException>(() => sut.GetManyToOneOperatorEvalStrategy(expectedOperator));
        ...
        public void GetManyToOneOperatorEvalStrategy_GivenUnsupportedOperator_ThrowsNotSupportedException(Operators @operator)
        {
            ...
            // Act
            var notSupportedException = Assert.Throws<NotSupportedException>(() => sut.GetManyToOneOperatorEvalStrategy(@operator));
        ...
        public void GetOneToManyOperatorEvalStrategy_GivenUnknownOperator_ThrowsNotSupportedException()
        {
            ...
            // Act
            var notSupportedException = Assert.Throws<NotSupportedException>(() => sut.GetOneToManyOperatorEvalStrategy(expectedOperator));
        ...
        public void GetOneToManyOperatorEvalStrategy_GivenUnsupportedOperator_ThrowsNotSupportedException(Operators @operator)
        {
            ...
            // Act
            var notSupportedException = Assert.Throws<NotSupportedException>(() => sut.GetOneToManyOperatorEvalStrategy(@operator));
        ...
        public void GetOneToOneOperatorEvalStrategy_GivenUnknownOperator_ThrowsNotSupportedException()
        {
            ...
            // Act
            var notSupportedException = Assert.Throws<NotSupportedException>(() => sut.GetOneToOneOperatorEvalStrategy(expectedOperator));
        ...
        public void GetOneToOneOperatorEvalStrategy_GivenUnsupportedOperator_ThrowsNotSupportedException(Operators @operator)
        {
            ...
            // Act
            var notSupportedException = Assert.Throws<NotSupportedException>(() => sut.GetOneToOneOperatorEvalStrategy(@operator));
