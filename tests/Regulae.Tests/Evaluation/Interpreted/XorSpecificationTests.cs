namespace Regulae.Tests.Evaluation.Interpreted
{
    ...
    {
        [Fact]
        public void IsSatisfiedBy_GivenLeftSpecificationEvalAsFalse_EvalsBothSpecificationsAndReturnsFalse()
        {
            // Arrange
            ...
            var sut = new XorSpecification<object>(expectedLeftSpecification, expectedRightSpecification);
        ...
        [Fact]
        public void IsSatisfiedBy_GivenLeftSpecificationEvalAsTrueAndRightSpecificationEvalAsFalse_EvalsBothSpecificationsAndReturnsTrue()
        {
            // Arrange
            var expectedInput = new object();
        ...
        [Fact]
        public void IsSatisfiedBy_GivenLeftSpecificationEvalAsFalseAndRightSpecificationEvalAsTrue_EvalsBothSpecificationsAndReturnsFalse()
        {
            // Arrange
            var expectedInput = new object();
