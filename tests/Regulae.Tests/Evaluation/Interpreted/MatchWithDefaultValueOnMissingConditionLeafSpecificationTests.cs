namespace Regulae.Tests.Evaluation.Interpreted
{
    ...
    public class MatchWithDefaultValueOnMissingConditionLeafSpecificationTests
    {
        ...
        public MatchWithDefaultValueOnMissingConditionLeafSpecificationTests()
        {
        ...
        public void And_GivenOtherSpecification_ReturnsAndSpecification()
        {
            ...
            var sut = new MatchWithDefaultValueOnMissingConditionLeafSpecification(this.valueConditionNodeMock, this.conditionEvalDispatcherProviderMock);
        ...
        [Fact]
        public void IsSatisfiedBy_GivenConditionsWithoutNeededInputCondition_FallsBackToDefaultAndReturnsConditionEvalDispatchResult()
        {
            // Arrange
            var expectedInput = new Dictionary<string, Operand>(StringComparer.Ordinal);
            Mock.Get(this.valueConditionNodeMock)
