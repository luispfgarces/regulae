namespace Regulae.Tests.Evaluation.Compiled
{
    ...
    public class OneToManyValueConditionNodeExpressionBuilderTests
    {
        ...
        public void Build_GivenLefthandOperatorRightHandAndDataTypeConfiguration_ReturnsExpression()
        {
            ...
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Regulae.Tests.Evaluation.Compiled.OneToManyValueConditionNodeExpressionBuilderTests.GoldenFile1.csx"))
            ...
            var oneToManyValueConditionNodeCompiler =
                new OneToManyValueConditionNodeExpressionBuilder(conditionExpressionBuilderProvider);
            ...
            var expressionResult = ExpressionBuilder.NewExpression("TestDummy")
                ...
                .SetImplementation(builder =>
                {
                    ...
                    {
                        oneToManyValueConditionNodeCompiler.Build(innerBuilder, args);
                    });
            ...
            FluentActions.Invoking(() => compiledLambdaExpression.Invoke(null, new[] { "dummy" }))
                .Should()
                .NotThrow("compiled expression should be executable");
            FluentActions.Invoking(() => compiledLambdaExpression.Invoke("abc", new[] { "dummy" }))
                .Should()
