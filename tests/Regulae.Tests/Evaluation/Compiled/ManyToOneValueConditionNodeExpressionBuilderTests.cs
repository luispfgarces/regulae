namespace Regulae.Tests.Evaluation.Compiled
{
    ...
    public class ManyToOneValueConditionNodeExpressionBuilderTests
    {
        ...
        public void Build_GivenLeftHandOperatorRightHandDataTypeConfiguration_ReturnsExpression()
        {
            ...
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Regulae.Tests.Evaluation.Compiled.ManyToOneValueConditionNodeExpressionBuilderTests.GoldenFile1.csx"))
            ...
            Mock.Get(conditionExpressionBuilderProvider)
                .Setup(x => x.GetConditionExpressionBuilderFor(Operators.Equal, Multiplicities.ManyToOne))
