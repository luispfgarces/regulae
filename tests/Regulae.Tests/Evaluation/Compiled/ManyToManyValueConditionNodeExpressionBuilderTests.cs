namespace Regulae.Tests.Evaluation.Compiled
{
    ...
    public class ManyToManyValueConditionNodeExpressionBuilderTests
    {
        ...
        public void Build_GivenLeftHandOperatorRightHandAndDataTypeConfiguration_ReturnsExpression()
        {
            ...
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Regulae.Tests.Evaluation.Compiled.ManyToManyValueConditionNodeExpressionBuilderTests.GoldenFile1.csx"))
            ...
            Mock.Get(conditionExpressionBuilderProvider)
                .Setup(x => x.GetConditionExpressionBuilderFor(Operators.Equal, Multiplicities.ManyToMany))
            ...
            FluentActions.Invoking(() => compiledLambdaExpression.Invoke(new[] { "abc" }, new[] { "dummy" }))
                .Should()
