namespace Regulae.Tests.Evaluation.Compiled.ConditionBuilders
{
    ...
    public class LesserThanOrEqualOneToOneConditionExpressionBuilderTests
    {
        ...
        {
            // Arrange
            var lesserThanOrEqualOneToOneConditionExpressionBuilder
            ...
            var expressionResult = ExpressionBuilder.NewExpression("TestCondition")
                ...
                .SetImplementation(builder =>
                {
                    ...
                    var conditionExpression = lesserThanOrEqualOneToOneConditionExpressionBuilder
        ...
        public void BuildConditionExpression_GivenLeftExpressionRightExpressionAndDataTypeConfigurationForString_ThrowsNotSupportedException()
        {
            ...
            // Act
            var notSupportedException = Assert.Throws<NotSupportedException>(() => lesserThanOrEqualOneToOneConditionExpressionBuilder
                .BuildConditionExpression(builder, args));
