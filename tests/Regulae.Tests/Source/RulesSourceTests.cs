namespace Regulae.Tests.Source
{
    ...
    public class RulesSourceTests
    {
        ...
        public async Task AddRuleAsync_NoMiddlewares_CallsRulesDataSource()
        {
            ...
            // Assert
            Mock.Get(rulesDataSource)
                .Verify(x => x.AddRuleAsync(It.Is<Rule>((val, _) => ReferenceEquals(val, rule))), Times.Once());
        }
        ...
        public async Task CreateRulesetAsync_NoMiddlewares_CallsRulesDataSource()
        {
            ...
            // Assert
            Mock.Get(rulesDataSource)
                .Verify(x => x.CreateRulesetAsync(It.Is<string>((val, _) => Equals(val, ruleset))), Times.Once());
        }
        ...
        public async Task UpdateRuleAsync_NoMiddlewares_CallsRulesDataSource()
        {
            ...
            // Assert
            Mock.Get(rulesDataSource)
                .Verify(x => x.UpdateRuleAsync(It.Is<Rule>((val, _) => ReferenceEquals(val, rule))), Times.Once());
        }
