namespace Regulae.Providers.MongoDb.IntegrationTests.Features.RulesEngine.RulesMatching
{
    using System;
    ...
    using Regulae.Providers.MongoDb.IntegrationTests.Features.RulesEngine;
    using Xunit;
    ...
    public class RulesUpdateDateEndTests : RulesEngineTestsBase
    {
        ...
        private List<RuleSpecification> CreateTestRules()
        {
            ...
            {
                new RuleSpecification(rule1, RuleAddPriorityOption.AtNumber(1)),
                new RuleSpecification(rule2, RuleAddPriorityOption.AtNumber(2))
            };
