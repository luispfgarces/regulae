namespace Regulae.Providers.MongoDb.IntegrationTests
{
    using DotEnv.Core;
    using System;
    ...
    internal static class SettingsProvider
    {
        ...
        public static string GetMongoDbHost()
        {
            ...
            var mongoDbHost = Environment.GetEnvironmentVariable("MONGO_DB_HOST") ?? environmentVariablesProvider["MONGO_DB_HOST"];
