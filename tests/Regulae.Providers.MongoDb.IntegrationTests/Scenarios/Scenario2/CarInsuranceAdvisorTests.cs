namespace Regulae.Providers.MongoDb.IntegrationTests.Scenarios.Scenario2
{
    using System;
    ...
    public sealed class CarInsuranceAdvisorTests : IDisposable
    {
        ...
        public CarInsuranceAdvisorTests()
        {
            ...
            var rulesFile = Assembly.GetExecutingAssembly()
                .GetManifestResourceStream("Regulae.Providers.MongoDb.IntegrationTests.Scenarios.Scenario2.regulae-tests.car-insurance-advisor.json");
