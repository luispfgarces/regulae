    ...
    internal static class RulesEngineOptionsValidator
    {
        public static void Validate(RulesEngineOptions rulesEngineOptions)
        {
            ...
            ValidateDataTypeDefault(
                ...
                DataTypes.Boolean,
                value => value != null && bool.TryParse(value.ToString(), out var _));
            ValidateDataTypeDefault(
                rulesEngineOptions.DataTypeDefaults,
                DataTypes.Decimal,
                value => value != null && decimal.TryParse(value.ToString(), NumberStyles.None, CultureInfo.InvariantCulture, out var _));
            ValidateDataTypeDefault(
                rulesEngineOptions.DataTypeDefaults,
                DataTypes.Integer,
                value => value != null && int.TryParse(value.ToString(), NumberStyles.None, CultureInfo.InvariantCulture, out var _));
            ValidateDataTypeDefault(
                rulesEngineOptions.DataTypeDefaults,
                DataTypes.String,
        ...
        {
            var value = dataTypeDefaults[dataType];
