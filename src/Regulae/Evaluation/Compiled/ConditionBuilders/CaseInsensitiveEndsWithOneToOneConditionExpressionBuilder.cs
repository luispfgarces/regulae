namespace Regulae.Evaluation.Compiled.ConditionBuilders
{
    ...
    internal sealed class CaseInsensitiveEndsWithOneToOneConditionExpressionBuilder : IConditionExpressionBuilder
    {
        ...
        private static readonly MethodInfo endsWithMethodInfo = typeof(string).GetMethod(
        ...
        public Expression BuildConditionExpression(IExpressionBlockBuilder builder, BuildConditionExpressionArgs args)
        {
            ...
            {
                throw new NotSupportedException($"The operator '{Operators.CaseInsensitiveEndsWith}' is not supported for data type '{args.DataTypeConfiguration.DataType}'.");
            }
