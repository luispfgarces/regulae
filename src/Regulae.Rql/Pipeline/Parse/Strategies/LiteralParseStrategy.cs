    ...
    internal class LiteralParseStrategy : ParseStrategyBase<Expression>, IExpressionParseStrategy
    {
        ...
        public override Expression Parse(ParseContext parseContext)
        {
            ...
            if (literalToken.Type == TokenType.DATE)
            {
                ...
                return LiteralExpression.Create(LiteralType.DateTime, literalToken, dateTimeLiteral);
            }
            ...
            return LiteralExpression.Create(inferredLiteralType, literalToken, literalToken.Literal);
        }
    }
}